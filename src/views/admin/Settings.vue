      ...
      <v-card>
        ...
        <v-card-text class="pa-4">
          <v-form ref="userFormRef" v-model="isUserFormValid" @submit.prevent="saveUser">
            ...
            <v-select v-model="userForm.groupId" :items="groups" item-title="name" item-value="id" label="Assigned Group" variant="outlined" clearable hint="Restricts MS/Publishers to only see reports for their group" persistent-hint />
          </v-form>
        </v-card-text>
